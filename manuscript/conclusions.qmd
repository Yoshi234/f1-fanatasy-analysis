...
small or large sized windows. This could be interpretted as
...
for future work we have several goals; first we need to automate the feature selection process so that there isn't any neeed for manual feature selection
